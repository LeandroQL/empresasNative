...
import { getEnterprise, getEnterprises, getStatus, getFilteredEnterprises } from '../actions/enterprise'
...
export const filterEnterprises = (header: any, type?: Number, name?: String) => {
    return async (dispatch) => {
        const url = `http://empresas.ioasys.com.br/api/v1/enterprises`
        await axios.get(url, {
            headers: {
